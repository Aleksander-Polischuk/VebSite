<?php
   ...
   $SQLExec = "select ID, PHONE, PASSWD_HASH, IS_ENT from USERS where PHONE='$phone' and IS_ENT=$account_type"; 
   ...
   if (mysqli_num_rows($res) > 0) {
	...
	if (password_verify($password, $password_hash)) {  // Якщо пароль вірний
            session_start();
   ...
   else { // Якщо користувач ще відстутній
